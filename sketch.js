...
function setup() {
	...
	rope6=new rope(bob6.body,roofObject.body,120)
...
function keyPressed() {
	if (keyCode === RIGHT_ARROW) {
 		Matter.Body.applyForce(bob6.body,bob6.body.position,{x:74,y:50});
	}
}
